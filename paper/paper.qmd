...
ggplot(cleaned_data_17_23, aes(x = xG, y = Gls, size = Poss, color = Poss)) +
  ...
  labs(title = "Bubble Chart of Goals vs Expected Goals",
       x = "Expected Goals",
       y = "Goals",
       size = "Possession (%)",
       color = "Possession (%)") +
...
ggplot(past_season_data, aes(x = Pts, y = PredictedPts)) +
  ...
  labs(x = "Actual Points",
       y = "Predicted Points",
       title = "Predicted vs. Actual Points Scatter Plot",
...
ggplot(long_data, aes(x = season, y = Points, group = Squad, color = Type)) +
  ...
  labs(x = "Season",
       y = "Points",
       title = "Time Series of Predicted vs. Actual Points by Team",
